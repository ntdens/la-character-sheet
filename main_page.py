...
#authenticate login
    ...
    with tab1:
        ...
        st.info('Use real name for Name field, used to track player across characters. Password must have at least 1 uppercase, 1 lowercase, 1 number and 1 special character and be 8 characters long.')
